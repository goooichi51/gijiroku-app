...
| **Standard** | ¥490 | ¥4,900 | 無制限録音・文字起こし、AI要約あり、全テンプレート、PDF出力、話者識別 |
| **Team**（v2.0） | ¥490/人 | ¥4,900/人 | Standard全機能+チーム共有・管理機能 |

**価格設定の根拠:**
- 文字起こしコスト: **0円**（ローカル処理）
- AI要約コスト: **約3円/時間**（Gemini 3 Flash）
- Standardプランで月20時間利用した場合の原価: 約60円 → **粗利率85%**
- ¥490/月は競合（Notta ¥1,185、Texter ¥1,500）の**約1/3〜1/2**の価格で強力な差別化
...
2. **圧倒的な低価格** - Standard ¥490/月は競合の1/3以下。API原価は月20時間利用でわずか約7円
